<p align="center">
    <img src="/art/socialcard.png" width="1280" title="Social Card of Laravel Response Cache">
</p>

# Laravel Response Cache Art
...
**Laravel Response Cache** logo is designed and maintained by [Caneco](https://twitter.com/caneco).

## License

All rights reserved, but with the following extra conditions:

- It is **OK** to use the Laravel Response Cache logo in the following cases:
...
- It is **NOT OK** to use the Laravel Response Cache logo in the following cases without prior written consent from the copyright owners:
    - Using the Laravel Response Cache logo in a commercial product for purposes other than illustrating its integration.
    - Sell physical products that uses the Laravel Response Cache logo or its variants, e.g. t-shirts.
